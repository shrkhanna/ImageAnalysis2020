...
dir_data  = "X:/delta_sav/raster/classification/training_test/201904/"

# output directory for classified files and for test data
dir_out   = "X:/delta_sav/raster/classification/methods/201904/tiffs/"

# model name
modname = "X:/delta_sav/raster/classification/methods/201904/RF_modelv6_191114.RData"

# image suffixes and names
# suffix of images to be processed (with all inputs)
imgsuf  = "all.img"
# suffix of output files
outsuf  = "201904RFdeltaV6"

# name of training and test csv files
name_trncsv = paste(dir_data, "R_201904_Catchall_Trn_corr_bolstered_noNA_primlow_v6.csv", sep="")
name_tstcsv = paste(dir_data, "R_201904_Catchall_Tst_corr_bolstered_noNA_primlow_v6.csv", sep="")

# name of the test data predicted class file which will be output
name_predict = paste(dir_out, "201904_Suisun_Test_pred_v6.csv", sep="")
# name of the file used to save importance of all variables in RF
name_impfile = paste(dir_out, "201904_Suisun_Test_imp_v6.csv", sep="")
...
classcol = match("species", trn_colnames)
